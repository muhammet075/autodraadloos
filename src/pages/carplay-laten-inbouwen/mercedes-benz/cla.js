...
export default function Cla() {
  ...
  const images = [
  {
    original: "/mercedes/CLA/w176-1.png",
    originalAlt: "yok",
    originalTitle: "",
    thumbnail: "/mercedes/CLA/w176-1.png",
    thumbnailAlt: "",
    thumbnailTitle: "",
  },
  {
    original: "/mercedes/CLA/w176-2.png",
    originalAlt: "yok",
    originalTitle: "",
    thumbnail: "/mercedes/CLA/w176-2.png",
    thumbnailAlt: "",
    thumbnailTitle: "",
  },
  {
    original:  "/mercedes/CLA/w176-3-groterscherm.jpeg",
    originalAlt: "yok",
    originalTitle: "",
    thumbnail:  "/mercedes/CLA/w176-3-groterscherm.jpeg",
    thumbnailAlt: "",
    thumbnailTitle: "",
  },
];
...
function checkOpties(e) {
  ...
  return (
    <>
        <Head>
            <title>AutoDraadloos.nl | Mercedes-Benz CLA CarPlay & Android Auto</title>
            <meta name="description" content="Laat Apple CarPlay & Android Auto professioneel inbouwen in uw Mercedes-Benz CLA bij AutoDraadloos.nl. Snelle installatie, kwaliteit gegarandeerd."/>
            <meta name="keywords" content="Mercedes-Benz CLA, W169, W176, W177, CarPlay, Android Auto, auto installatie, AutoDraadloos, autoradio, scherm"/>
            <meta property="og:title" content="AutoDraadloos.nl | CarPlay & Android Auto voor Mercedes-Benz CLA"/>
            <meta property="og:description" content="Professionele installatie van Apple CarPlay & Android Auto voor uw Mercedes-Benz CLA bij AutoDraadloos.nl. Vraag direct een offerte aan."/>
            <meta property="og:url" content="https://www.autodraadloos.nl/carplay-laten-inbouwen/mercedes-benz/CLA/"/>
            <meta property="og:type" content="website"/>
        </Head>


      <Pagehero pagetitle="CLA"/>
      ...
      <div className={styles.productpagina}>
        ...
        <div>
            ...
            <div className={styles.productgegevens}>
                <h2>Apple CarPlay & Android Auto voor de CLA</h2>
